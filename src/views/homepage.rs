...
impl HomepageView {
    ...
    pub fn display_button_start(&self, ui: &mut UiCell, widget_ids: &WidgetIds, event: &Event, model: &mut GameInfo) {
    ...
    pub fn display_dropdown_button_game_mode(&self, ui: &mut UiCell, widget_ids: &WidgetIds, event: &Event, model: &mut GameInfo) {
    ...
    pub fn display_toggle_button(&self, ui: &mut UiCell, widget_ids: &WidgetIds, event: &Event, model: &mut GameInfo) {
    ...
    pub fn display_number_dialer_first_ia_depth(&self, ui: &mut UiCell, widget_ids: &WidgetIds, event: &Event, model: &mut GameInfo) {
        ...
        {
            println!("first ia");
            if let Event::number_dialer_first_ia_depth(event) = event {
                event(model, new_depth);
            }
        }
    }

    pub fn display_number_dialer_second_ia_depth(&self, ui: &mut UiCell, widget_ids: &WidgetIds, event: &Event, model: &mut GameInfo) {
        ...
        {
            println!("second ia");
            if let Event::number_dialer_second_ia_depth(event) = event {
                event(model, new_depth);
            }
        }
    }
